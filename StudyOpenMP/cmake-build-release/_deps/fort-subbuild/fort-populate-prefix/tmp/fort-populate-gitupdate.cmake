...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v0.4.2"
  WORKING_DIRECTORY "D:/Users/PERSONAL/CLionProjects/StudyOpenMP/cmake-build-release/_deps/fort-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v0.4.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v0.4.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Users/PERSONAL/CLionProjects/StudyOpenMP/cmake-build-release/_deps/fort-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Users/PERSONAL/CLionProjects/StudyOpenMP/cmake-build-release/_deps/fort-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
